...
const collectionConfigs = {
	extensions: {
		...
		sortOptions: [
			{ value: 'recent_downloads_7_days:desc', label: 'Trending - 7 Days' },
			{ value: 'recent_downloads_30_days:desc', label: 'Trending - 30 Days' },
			{ value: 'last_updated:desc', label: 'Recently Updated' },
			{ value: 'total_downloads:desc', label: 'Total Downloads' },
